...
const WithdrawStepper = ({ classes, messages, maxAmount, onWithdraw, withdraw, onDone }) => {
            ...
            <div className={classes.actionsContainer}>
              <div className={classes.divBackAndConfirm}>
                ...
                <div className={classes.wrapper}>
                  ...
                  { withdraw.isLoading && (<CircularProgress size={24} className={classes.buttonProgress} />)}
                </div>
              </div>
            </div>
          </StepContent>

  ...
  return (
    <div className="d-flex align-items-center flex-column vh-100 justify-content-center text-center py-3">
      <div className="d-flex align-items-center flex-column px-4">
        <PulseLoader color={theme.palette.primary.main} loading={true} />
        <Typography className="text-muted font-size-xl text-center pt-3">
          ...
          <Typography component="span" className="font-size-lg d-block text-dark">
            {messages['If you have any issues please contact']} <a href="https://twitter.com/NolanVanmoortel" target="_blank" rel="noopener noreferrer">@NolanVanmoortel</a>
          </Typography>
        </Typography>
      </div>
    </div>
